...
public class RequestShowPage extends JFrame {
    ...
    public RequestShowPage() {
        ...
        ok_button.setFont(new Font("Segoe UI Black", 1, 12)); // NOI18N
        ok_button.setForeground(new Color(255, 255, 255));
        ok_button.setText("discard request");
    ...
    {
    	RequestShowPage rsqp = new RequestShowPage();
